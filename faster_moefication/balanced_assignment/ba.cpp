...
std::pair<torch::Tensor, int> balanced_assignment(torch::Tensor job_and_worker_to_score, int max_iterations) {
  // int max_iterations = 100;
  // torch::Tensor epsilon =
  //     (job_and_worker_to_score.max() - job_and_worker_to_score.min()) / 50;
  torch::Tensor epsilon =
      (job_and_worker_to_score.max() - job_and_worker_to_score.min()) / max_iterations * 2;
